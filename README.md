...
[Descarga y configuración para Flight](https://flightphp.com/install) <br>
Realizar los puntos 1 y 2
...
```sh
http://localhost/API_PHP_Alumnos/alumnos
```
### POST: Guardar nuevos registros
```sh
http://localhost/API_PHP_Alumnos/alumnos
```
####    Ejemplo:
...
### GET: Búsqueda por ID
```sh
http://localhost/API_PHP_Alumnos/alumnos/{id}
```
####    Ejemplo:
```sh
http://localhost/API_PHP_Alumnos/alumnos/1
```
